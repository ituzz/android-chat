...
public class Config {
     ...
     * <br>
     */
    public static String IM_SERVER_HOST = "124.221.213.135" /*请仔细阅读上面的注释，没有 http 前缀，配置错误时，APP 会提示配置错误，然后直接退出*/ = "wildfirechat.net";

    // 注意APP_SERVER_ADDRESS已从kit中移除，移动到了AppService.java中
    //public static String APP_SERVER_ADDRESS = "http://124.221.213.135:8888";
